...
//! A basic version of the constructor.
		...
		*/
		...
		inline const std::vector<Real> * getTimeLocations() const {return &time_locations_;}
		...
		inline const MatrixXr * getDOF_matrix() const {return &dof_matrix_;}

		inline const MatrixXr * getBarycenters() const {return &barycenters_;}
		inline const VectorXi * getElementIds() const {return &element_ids_;}
