...
#include "../../FE_Assemblers_Solvers/Headers/IntegratePsi.h"
#include "../../FE_Assemblers_Solvers/Headers/Kronecker_Product.h"
...
class MixedFERegressionBase
{
	protected:
		...
		bool isGAMData      =
			std::is_same<InputHandler, GAMDataLaplace>::value ||
			std::is_same<InputHandler, GAMDataEllipticSpaceVarying>::value ||
			std::is_same<InputHandler, GAMDataElliptic>::value;
	...
	public:
		...
		inline MatrixXr const & getDOF(void) const {return _dof;}
