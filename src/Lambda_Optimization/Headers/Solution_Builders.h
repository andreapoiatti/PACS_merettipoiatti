...
namespace Solution_Builders  //Unique class to manage the output
{
        ...
        static SEXP build_solution_plain_regression(const VectorXr & solution, const output_Data & output, const MeshHandler<ORDER, mydim, ndim> & mesh, const InputHandler & regressionData);
};
