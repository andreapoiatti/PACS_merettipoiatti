CPP_smooth.volume.FEM.basis<-function(locations, observations, FEMbasis,  covariates = NULL, incidence_matrix = NULL, ndim, mydim, BC = NULL, opt_method, lambdas = NULL, initial_lambda = NULL, realizations = 100)
{
