CPP_smooth.FEM.basis<-function(locations, observations, FEMbasis, covariates = NULL, incidence_matrix = NULL, ndim, mydim, BC = NULL, opt_method, lambdas = NULL, initial_lambda = NULL, nrealizations = 100)
{
  ...
  bigsol <- .Call("regression_Laplace", locations, observations, FEMbasis$mesh, FEMbasis$order,
                  mydim, ndim, covariates, incidence_matrix, BC$BC_indices, BC$BC_values,
                  opt_method, lambdas, initial_lambda, nrealizations, PACKAGE = "fdaPDE")
  return(bigsol)
}

CPP_smooth.FEM.PDE.basis<-function(locations, observations, FEMbasis, PDE_parameters, covariates = NULL, incidence_matrix = NULL, ndim, mydim, BC = NULL, opt_method, lambdas = NULL, initial_lambda = NULL, nrealizations = 100)
{
  ...
  bigsol <- .Call("regression_PDE", locations, observations, FEMbasis$mesh, FEMbasis$order, mydim, ndim,
                  PDE_parameters$K, PDE_parameters$b, PDE_parameters$c, covariates, incidence_matrix,
                  BC$BC_indices, BC$BC_values, opt_method, lambdas, initial_lambda, nrealizations, PACKAGE = "fdaPDE")
  return(bigsol)
}

CPP_smooth.FEM.PDE.sv.basis<-function(locations, observations, FEMbasis, PDE_parameters, covariates = NULL, incidence_matrix = NULL, ndim, mydim, BC = NULL, opt_method, lambdas = NULL, initial_lambda = NULL, nrealizations = 100)
{
  ...
  bigsol <- .Call("regression_PDE_space_varying", locations, observations, FEMbasis$mesh, FEMbasis$order,
                  mydim, ndim, PDE_param_eval$K, PDE_param_eval$b, PDE_param_eval$c, PDE_param_eval$u,
                  covariates, incidence_matrix, BC$BC_indices, BC$BC_values, opt_method, lambdas, 
                  initial_lambda, nrealizations, PACKAGE = "fdaPDE")
  return(bigsol)
}
...
### TO BE REINTEGRATED IN THE FINAL VERSION OF THE CODE [[TODO]]
